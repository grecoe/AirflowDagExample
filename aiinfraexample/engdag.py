...
def mock_key_retrieval(**context):
    return {ConfigurationConstants.COGSRCH_ADMIN_KEY : "MOCK_KEY_TEMP_"}
...
with DAG(
    ...
    get_search_key >> get_datastore_details_task >> retrieve_file_task >> upload_file_task >> trigger_indexer_task
